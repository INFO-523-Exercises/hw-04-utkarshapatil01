...
X <- data$open
y_true <- data$adj_close
y <- y_true + matrix(rnorm(numInstances), ncol=1) # Adding Guassian Noise
...
It is a method used for the tuning of the model, which helps in dealing with the problem of multicollinearity between the independent variables.
